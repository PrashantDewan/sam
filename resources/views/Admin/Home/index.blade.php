...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>E</b>FT</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">EFuniture</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('admin.users.admin')}}"><i class="fa fa-circle-o "></i> Admin</a></li>
            <li><a href="{{ route('admin.users.user') }}"><i class="fa fa-circle-o"></i> Users</a></li>
          </ul>
        </li>
        <li>
